...
const Info = () => {
    return (
        <section className="text-gray-300 body-font bg-[#1f171c]">
                ...
                <div className="flex flex-wrap -m-4">
                    <div className="xl:w-1/3 md:w-1/2 p-4">
                        <div className="border border-gray-700 border-opacity-75 p-6 rounded-lg">
                            <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-gray-800 text-yellow-600 mb-4">
                                <svg fill="none" stroke="currentColor" strokLinecap="round" strokLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
